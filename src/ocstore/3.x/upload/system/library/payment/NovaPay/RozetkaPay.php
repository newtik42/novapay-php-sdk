...
class RozetkaPay {
    ...
    public function paymentRefund(PaymentRequest $data) {
        ...
        if($headerCode == 200){
            ...
            $result = new Payment\ResponsesSuccess($jsonResponse);
            
        }else{
            
            $result = new Payment\ResponsesError($jsonResponse);
    ...
    public function paymentInfo($external_id) {
        ...
        if($headerCode == 200){            
            return new Payment\ResponsesInfoSuccess($jsonResponse);            
        }else{
            return new Payment\ResponsesInfoSuccess([]);
        }
    ...
    public function сallbacks(){
        ...
        return new Payment\ResponsesSuccess($json);
