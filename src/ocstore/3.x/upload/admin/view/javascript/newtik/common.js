...
function NTaddTableRow(e, tableId, data = {}) {
...
//    window[tableId + '_row_data_empty'] = {
//        id:''
//    };
...
function NTdelTableRow(e, tableId, blackMark = false) {
    if(blackMark){
        let el = $(e).parents('tr')   
        NT_TableRowToggleBlackMark(el, $(e), el.find('input[blackMark]'))
    }else{
        $(e).parents('tr').remove()
    }
}

function NT_TableRowToggleBlackMark(row, buuton, inputBlackMark){
